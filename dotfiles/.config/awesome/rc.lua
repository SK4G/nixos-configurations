...
globalkeys = my_table.join(
    ...
    awful.key({ modkey1, altkey   }, "e", function() awful.util.spawn( "emote" ) end,
        {description = "emoji picker", group = "alt+ctrl"}),
    ...
    awful.key({ modkey1, altkey   }, "m", function() awful.util.spawn( "mousepad" ) end,
        {description = "mousepad", group = "alt+ctrl"}),
